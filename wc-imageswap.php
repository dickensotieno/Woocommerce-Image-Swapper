...
function reg_wcpis_script(){
	...
	load_plugin_textdomain( 'wc-productswap', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' );	
	}
}
?>
<?php
...
if (!class_exists('WCPI_Swap')) {
	class WCPI_Swap {
		...
		var $localizationDomain = 'wc-productswap';
...
/*-----------------------------------------------------------------------------------*/
_e('WooCommerce image swap options', '$this->localizationDomain'); ?>
  </div>
